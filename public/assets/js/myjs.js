...
$(document).ready(function () {
    ...
    $(function () {
        ...
        // Initialize the date range picker with autoUpdateInput disabled so it remains blank by default

        $('.simpledate').datepicker({
            autoclose: true,
            format: "dd-M-yyyy",
            todayHighlight: true
        });

        $('#order_date_two').daterangepicker({
            autoclose: true,
            format: "dd-M-yyyy",
            autoUpdateInput: false, // Keeps the field blank on page load
            todayHighlight: true
        });

        // When a date range is selected, update the input and trigger searchData
        $('#order_date_two').on('apply.daterangepicker', function (ev, picker) {
            ...
            // Call the searchData function with the defined parameters
