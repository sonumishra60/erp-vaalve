...
@section('content')
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack p-0 m-0">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1 ml-10">
                    ...
                    <li class="breadcrumb-item text-dark">Dispatch List</li>

                </ul>
                <!--end::Title-->

                {{-- <div class="d-flex align-items-center ml-10">
                    <a href="#" data-id="" class="btn btn-sm btn-primary  dispatchbutton"  style='margin-right: 10px;padding: 4px !important;font-size: 8px;' > Partially <div
                        class="spinner-border d-none distriloader" role="status">
                    </div> </a>
    
                    <a href="#" data-id="complete" class="btn btn-sm btn-success pull-right dispatchbutton" style='margin-right: 10px;padding: 4px !important;font-size: 8px;' > Complete <div
                            class="spinner-border d-none distriloader" role="status">
                        </div> </a>
                </div> --}}
    ...
    <div class="post d-flex flex-column-fluid" id="kt_post">
        ...
        <div id="kt_content_container" class="container-xxl">
            ...
            <input type="hidden"  id="dispatchtype" value="">
        </div>
        <!--end::Container-->
    </div>
@endsection
...
@section('js')
    <script>
        ...
        function fetchData(rowCount, page, dispatchtype) {
                ...
                success: function(response) {
                    ...
                    if (countdata != 0) {
                        $.each(response.data, function(index, value) {
                            ...
                            var dispatchdetail = "{{ route('dispatch.detail', ':id')  }}";
                            dispatchdetail = dispatchdetail.replace(':id', value.orderAuthKey);

                            var comdispatchdetail = "{{ route('dispatch.completedetail', ':id')  }}";
                            compdispatchdetail = comdispatchdetail.replace(':id', value.orderAuthKey);
                            ...
                            var tr = ` <tr>
                                    ...
                                    <td class="w-100px rounded-start"> <div class="text-centern tblicon">
                                        <a href="`+ dispatchdetail +`" > <i class="fa fa-edit text-primary"></i> </a>
                                        <a href="`+ compdispatchdetail +`" > <i class="fa fa-eye text-primary"></i> </a>
                                    </div></td>
        ...
        function updatePagination(response) {
            ...
            $('#pagination a').on('click', function(event) {
                ...
                fetchData(10, page, dispatchtype); // Fetch data for the clicked page
            });
        }
        ...
        //     $('#dispatchtype').val(button);

        //     fetchData(10, 1, button);
        // });
        ...
        function searchData(searchParams) {
            ...
            $.ajax({
                url: "{{ route('dispatch.pendingsearch') }}",
                method: 'GET',
                data: searchParams,
                success: function(response) {
                    $('#tbody').empty();
