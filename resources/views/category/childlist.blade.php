        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack p-0 m-0">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1 ml-10">
                    ...
                    <li class="breadcrumb-item text-dark">{{ $mastermenuid->name }}</li>
            ...
            <div class="d-flex align-items-center mr-20px">
                <a onclick="history.back()" class="btn btn-sm btn-primary modal-show">Back</a>
            </div>
            <!--end::Page title-->
        </div>
        <!--end::Container-->
            ...
            <div class="row mb-xl-8">
                <div class="card">
                    <div class="card-body py-3">
                        <input type='hidden' id="checkauthkey" value="{{ $mastermenuid->masterMenuId }}">
...
@section('js')
    <script>
        ...
        function fetchData(rowCount, page) {
            ...
            var checkauthkey = $('#checkauthkey').val();
         
            $.ajax({
                url: "{{ route('category.childdata') }}",
                method: 'GET',
                data: {
