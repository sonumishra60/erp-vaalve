        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack p-0 m-0">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1 ml-10">
                    ...
                    <li class="breadcrumb-item text-dark">Distribution Network- Update</li>
                ...
                <div class="card">
                    ...
                    <!-- <div class="card-header border-0">
                                            <h3 class="card-title align-items-start flex-column">
                                                <span class="card-label fw-bolder fs-3 mb-1">Add Dower</span>
                    ...
                    <div class="card-body py-3">
                        ...
                        <div class="row">
                            ...
                            <input type="hidden" id="customer_id" value="{{ $customerdata->customerId }}" />
                            ...
                            <div class="accordion accordion-primary" id="accordion-1">
                                <div class="accordion-item accordion-bg">
                                    <div class="accordion-header rounded-lg collapsed" id="headingOne"
                                        ...
                                        <span class="accordion-header-text fs-14">Distribution Network
                                            Type</span>
                                                        ...
                                                        <div class="col-sm-4 mb-1">
                                                            <div class="floating-label-group">
                                                                <input type="text" id="nature_name"
                                                                    ...
                                                                    value="{{ $customerdata->ownerName }}" autofocus
                                                                    required />
                                                            ...
                                                            <div class="floating-label-group">
                                                                <input type="text" id="consignee_name"
                                                                    class="form-control" autocomplete="off" autofocus
                                                                      value="{{ $customerdata->consigneeName }}"
                                                                    required />
                                                        ...
                                                        <div class="col-sm-4 mb-1">
                                                            <div class="floating-label-group">
                                                                <input type="text" id="nature_mobile_no"
                                                                    ...
                                                                    value="{{ $customerdata->ownerNumber }}"
                                                                    class="form-control" autocomplete="off" autofocus
                                                                    required />
                                                                <label class="floating-label"> Whatsapp Mobile
                                                        ...
                                                        <div class="col-sm-4 mb-4">
                                                            <div class="floating-label-group">
                                                                <input type="text" id="gst"
                                                                    class="form-control text-uppercases"
                                                                    value="{{ $customerdata->gstCertificate }}"
                                                                    autocomplete="off" autofocus required />
                                                                <label class="floating-label">GST <span
                                                                        class="text-danger">*</span> </label>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="mb-1 row">
                                                        <div class="col-sm-4 mb-1">
                                                            ...
                                                            <div class="form-floating">
																		<textarea class="form-control"  id="street">{{ $customerdata->address }}</textarea>
                                                        ...
                                                        <div class="col-sm-4 mb-1">
                                                            ...
                                                            <div class="float-select">
                                                                <select class="form-select form-select-sm"
                                                                    data-control="select2" id="select_district"
                                                                    data-placeholder=" ">
                                                            ...
                                                            <div class="floating-label-group mt-1">
                                                                <input type="text" id="pin_code" class="form-control"
                                                                    maxlength="6" value="{{ $customerdata->pincode }}"
                                                                    onkeypress="return event.charCode >= 48 &amp;&amp; event.charCode <= 57"
                                                                    autocomplete="off" autofocus required />
                                                        ...
                                                        <div class="col-sm-4 mb-1">
                                                            ...
                                                            <div class="float-select">
                                                                ...
                                                                <label class="new-labels"> Select City 
                                                                    <span
                                                                        class="text-danger">*</span> </label>
                                                            </div>
                                                            ...
                                                            <div class="float-select">
                                                                ...
                                                                <label class="new-labels"> Select Zone </label>
                                                            </div>
                                                    ...
                                                    <div class="col-sm-4 mb-1">
                                                        <div class="floating-label-group">
                                                            <input type="text" id="one_year_vaalve"
                                                                class="form-control"
                                                                value="{{ @$vaalveturnover->firstYear }}" maxlength="10"
                                                                onkeypress="return event.charCode >= 48 &amp;&amp; event.charCode <= 57"
                                                                autocomplete="off" autofocus required />
                                                            <label class="floating-label">Year 1</label>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-4 mb-1">
                                                        <div class="floating-label-group mt-1">
                                                            <input type="text" id="two_year_vaalve"
                                                                value="{{ @$vaalveturnover->secondYear }}"
                                                    ...
                                                    <div class="col-sm-4 mb-1">
                                                        <div class="floating-label-group mt-1">
                                                            <input type="text" id="three_year_vaalve"
                                                                value="{{ @$vaalveturnover->thirdYear }}"
                                                                class="form-control " maxlength="10"
                                                                onkeypress="return event.charCode >= 48 &amp;&amp; event.charCode <= 57"
                                                                autocomplete="off" autofocus required />
                                                            <label class="floating-label px">Year
                                                    ...
                                                    <div class="col-sm-4 mb-1">
                                                        <div class="floating-label-group">
                                                            <input type="text" id="one_year_company"
                                                                class="form-control"
                                                                value="{{ @$companyturnover->firstYear }}" maxlength="10"
                                                                onkeypress="return event.charCode >= 48 &amp;&amp; event.charCode <= 57"
                                                                autocomplete="off" autofocus required />
                                                            <label class="floating-label">Year 1 </label>
                                                        </div>
                                                    ...
                                                    <div class="col-sm-4 mb-1">
                                                        <div class="floating-label-group mt-1">
                                                            <input type="text" id="two_year_company"
                                                                value="{{ @$companyturnover->secondYear }}"
                                                                class="form-control " maxlength="10"
                                                                onkeypress="return event.charCode >= 48 &amp;&amp; event.charCode <= 57"
                                                                autocomplete="off" autofocus required />
                                                            <label class="floating-label px">Year
                                                    ...
                                                    <div class="col-sm-4 mb-1">
                                                        <div class="floating-label-group mt-1">
                                                            <input type="text" id="three_year_company"
                                                                value="{{ @$companyturnover->thirdYear }}"
                                                                class="form-control " maxlength="10"
                                                                onkeypress="return event.charCode >= 48 &amp;&amp; event.charCode <= 57"
                                                                autocomplete="off" autofocus required />
                                                            <label class="floating-label px">Year
                                    ...
                                    <div class="accordion-body-text mt-4">
                                        ...
                                        <div class="basic-form">
                                            <form method="POST" id="form6">
                                                ...
                                                @foreach ($contactperson as $key => $item)
                                                    <div class="mb-1 row">
                                                        <div class="col-sm-2 mb-1">
                                                        ...
                                                        <div class="col-sm-2 mb-1">
                                                            ...
                                                            <div class="floating-label-group">
                                                                <input type="text" name="contact_person_degination[]"
                                                                    value="{{ $item->degination }}" class="form-control"
                                                                    autocomplete="off" autofocus required />
                                                                <label class="floating-label">Designation <span
                                                                        class="text-danger">*</span> </label>
                                                            </div>
                                                        ...
                                                        <div class="col-sm-3 mb-1">
                                                            ...
                                                            <div class="floating-label-group mt-1">
                                                                <input type="text" name="contact_person_email[]"
                                                                    value="{{ $item->emailId }}" class="form-control "
                                                                    autocomplete="off" autofocus required />
                                                                <label class="floating-label px">Email <span
                                                                        class="text-danger">*</span> </label>
                                                            </div>
                                            ...
                                            <form method="POST" id="form7">
                                                <div class="mb-1 row">
                                                    ...
                                                    <div class="col-sm-4 ">
                                                        <div class="float-select">
                                                            <select class="form-select form-select-sm" id="bank_type">
                                                                <option value="Saving"
                                                                    {{ @@$bankdata->accountTpe == 'Saving' ? 'selected' : '' }}>
                                                                    Saving</option>
                                                                <option value="Current"
                                                                    {{ @@$bankdata->accountTpe == 'Current' ? 'selected' : '' }}>
                                                                    Current</option>
                                                            </select>
                                                    ...
                                                    <div class="col-sm-4 ">
                                                        ...
                                                        <div class="floating-label-group">
                                                            ...
                                                            maxlength="17"
                                                                value="{{ @@$bankdata->accountNo }}" class="form-control"
                                                                autocomplete="off"
                                                                onkeypress="return event.charCode >= 48 &amp;&amp; event.charCode <= 57"
                                                                autofocus required />
                                                    ...
                                                    <div class="col-sm-4">
                                                        ...
                                                        <div class="floating-label-group mt-1">
                                                            <input type="text" id="account_holder_name"
                                                                class="form-control "
                                                                value="{{ @$bankdata->accountHolder }}" autocomplete="off"
                                                                autofocus required />
                                                            <label class="floating-label px">Enter
                                                    ...
                                                    <div class="col-sm-4">
                                                        ...
                                                        <div class="floating-label-group">
                                                            <input type="text" id="ltd_llp"
                                                                ...
                                                                value="{{ $customerdata->categoryNm }}"
                                                                autocomplete="off" autofocus required />
                                                            <label class="floating-label">LTD/LLP </label>
                                                        </div>
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="floating-label-group">
                                                            <input type="text" id="security_amount" maxlength="10"
                                                                onkeypress="return event.charCode >= 48 &amp;&amp; event.charCode <= 57"
                                                                class="form-control " autocomplete="off"
                                                                value="{{ $customerdata->securityAmount }}" autofocus
                                                                required />
                                                    ...
                                                    <div class="col-sm-4 ">
                                                        <div class="float-select">
                                                            <select class="form-select form-select-sm" id="blank_cheq">
                                                                <option value="1"
                                                                    {{ $customerdata->securityDepoPaymentMode == '1' ? 'selected' : '' }}>
                                                                    Yes</option>
                                                                <option value="0"
                                                                    {{ $customerdata->securityDepoPaymentMode == '0' ? 'selected' : '' }}>
                                                                    NO</option>
                                                            </select>
                                                ...
                                                <div class="mb-4 row">
                                                    <div class="col-sm-4">
                                                        ...
                                                        <div class="floating-label-group mt-1">
                                                            <input type="text" id="credit_period"
                                                                value="{{ $customerdata->creditPeriod }}"
                                                                class="form-control " autocomplete="off" autofocus
                                                                required />
                                                            <label class="floating-label w-100px">Credit
                                                    ...
                                                    <div class="col-sm-4">
                                                        ...
                                                        @php
                                                            $receivedDate = '';
                                                            if($customerdata->receivedDate){
                                                                $receivedDate =  date('d-M-Y', $customerdata->receivedDate);
                                                            }
                                                        @endphp
                                                        <div class="floating-label-group mt-1">
                                                            <input type="text" id="bank_check_recieved_date"
                                                                value="{{ $receivedDate }}"
                                                                class="form-control bank_check_recieved_date" autocomplete="off" autofocus
                                                                required />
                                                    ...
                                                    <div class="col-sm-4 mb-1">
                                                        ...
                                                        <div class="floating-label-group mt-1">
                                                            <input type="text" id="amount" class="form-control "
                                                                value="{{ $customerdata->amount }}" maxlength="10"
                                                                onkeypress="return event.charCode >= 48 &amp;&amp; event.charCode <= 57"
                                                                autocomplete="off" autofocus required />
                                                    ...
                                                    <div class="col-sm-6 mb-1">
                                                        <div class="floating-label-group">
                                                            <input type="text" id="security_check_detail"
                                                                value="{{ $customerdata->securityChq }}"
                                                ...
                                                <div class="mb-1 row">
                                                    <div class="col-sm-3 mb-1 d-flex mt-2">
                                                        ...
                                                        <div class="image-input image-input-empty"
                                                            ...
                                                            @if ($customerdata->bankChq != '')
                                                                <div class="d-flex">
                                                                    <img src="{{ URL::asset('document') . '/' . $customerdata->bankChq }}"
                                                                    class="productimg">
                                                                </div> 
                                                            @endif
                                                            <input type="hidden" id="chquebook_image_old"
                                                                value="{{ $customerdata->bankChq }}">
                                                            <!--end::Remove button-->
                                                        </div>
                                                        <div class="check"
                                                    ...
                                                    <div class="col-sm-3 mb-1 d-flex mt-2">
                                                        ...
                                                        <div class="image-input image-input-empty"
                                                            ...
                                                            @php
                                                                $bankChqImages = unserialize(
                                                                    @$bankdata->blankChqueScanCopy,
                                                                );
                                                                // print_r($bankChqImages);
                                                                // die();
                                                            @endphp

                                                            @if (!empty($bankChqImages))
                                                            <div class="d-flex">
                                                                @foreach ($bankChqImages as $image)
                                                                    <img src="{{ URL::asset('document/' . $image) }}"
                                                                    class="productimg"  style="width:30px;">
                                                                @endforeach
                                                            </div>
                                                            @endif

                                                            <input type="hidden" id="cheque_image_old"
                                                                value="{{ @$bankdata->blankChqueScanCopy }}">
                                                    ...
                                                    <div class="col-sm-3 mb-1 d-flex mt-2">
                                                        ...
                                                        <div class="image-input image-input-empty"
                                                            ...
                                                            @php
                                                                $agreementImage = unserialize(
                                                                    $customerdata->agreementImage,
                                                                );
                                                            @endphp

                                                            @if (!empty($agreementImage))
                                                                <div style="font-size: 13px;width: 80px;float: left;" >
                                                                    @foreach ($agreementImage as $image)
                                                                        <!-- <img src="{{ URL::asset('document/' . $image) }}"
                                                                        class="productimg"  style="width:30px;"> -->
                                                                        <a href="{{URL::asset('document/' . $image) }}" target="_blank">Click Here</a>
                                                                    @endforeach
                                                                </div>
                                                            @endif

                                                            <input type="hidden" id="agreement_image_old"
                                                                value="{{ $customerdata->agreementImage }}">
                                                ...
                                                <div class="mb-1 row">
                                                    ...
                                                    <div class="col-sm-4 mb-1">
                                                        ...
                                                        <div class="floating-label-group">
                                                            ...
                                                            maxlength="16"
                                                                value="{{ @$adhardata->documentNumber }}"
                                                                onkeypress="return event.charCode >= 48 &amp;&amp; event.charCode <= 57"
                                                                autocomplete="off" autofocus required />
                                                            <label class="floating-label px">Enter Doc Number <span
                                                                    class="text-danger">*</span> </label>
                                                        </div>
                                                    ...
                                                    <div class="col-sm-2 mb-1 d-flex">
                                                        ...
                                                        @if (@$adhardata->docFrontImage != '')
                                                            <div class="d-flex">
                                                                <img src="{{ URL::asset('document') . '/' . $adhardata->docFrontImage }}"
                                                                        class="productimg">
                                                             </div>
                                                        @endif

                                                        <input type="hidden" id="adahar_front_image_old"
                                                            value="{{ @$adhardata->docFrontImage }}">
                                                    ...
                                                    <div class="col-sm-2 mb-1 d-flex">
                                                        ...
                                                        @if (@$adhardata->docBackImage != '')
                                                            <div class="d-flex">
                                                                <img src="{{ URL::asset('document') . '/' . $adhardata->docBackImage }}"
                                                                        class="productimg" >
                                                             </div>
                                                        @endif

                                                        <input type="hidden" id="adahar_back_image_old"
                                                            value="{{ @$adhardata->docBackImage }}">
                        ...
                        <div class="accordion accordion-primary" id="accordion-10">
                            <div class="accordion-item accordion-bg">
                                <div class="accordion-header rounded-lg collapsed" id="heading10"
                                                ...
                                                <div class="mb-1 row">
                                                    <div class="col-sm-4 mb-1">
                                                        ...
                                                        <div class="floating-label-group">
                                                            ...
                                                            maxlength="10"
                                                                class="form-control text-uppercase" autocomplete="off"
                                                                value="{{ @$pandata->documentNumber }}" autofocus
                                                                required />
                                                    ...
                                                    <div class="col-sm-2 mb-1 d-flex">
                                                        ...
                                                        <div class="check"
                                                        style="line-height: 60px; padding-left: 5px; font-size: 11px;">
                                                        PanCard front <span class="text-danger">*</span> </div>
                                                        <!--end::Image input-->

                                                        <input type="hidden" id="pan_card_image_old"
                                                            value="{{ @$pandata->docFrontImage }}">
                                                            
                                                        @if (@$pandata->docFrontImage != '')
                                                            <div class="d-flex">
                                                                <img src="{{ URL::asset('document') . '/' . $pandata->docFrontImage }}"
                                                                        class="productimg">
                                                             </div>
                                                        @endif
                                        ...
                                        <div class="basic-form">
                                            <form method="POST" id="form9">
                                                <div class="mb-1 row">
                                                    <div class="col-sm-2 mb-1">
                                                        <div class="floating-label-group">
                                                            <input type="text" id="faucet_ex_fc_disc" 
                                                            onkeypress="return (event.charCode >= 48 && event.charCode <= 57) || event.charCode === 46"
                                                                class="form-control text-uppercase" autocomplete="off" value="{{ $customerdata->faucet_ex_fc_disc }}"
                                                                autofocus required />
                                                    ...
                                                    <div class="col-sm-2 mb-1">
                                                        <div class="floating-label-group">
                                                            <input type="text" id="faucet_dealer_scheme_discount"
                                                                onkeypress="return (event.charCode >= 48 && event.charCode <= 57) || event.charCode === 46"
                                                              value="{{ $customerdata->faucet_dealer_scheme_discount }}"
                                                                class="form-control text-uppercase" autocomplete="off"
                                                                autofocus required />
                                                            <label class="floating-label px">Dealer Scheme Discount</label>
                                                        </div>
                                                    </div>

                                                    <div class="col-sm-2 mb-1">
                                                        <div class="floating-label-group">
                                                            <input type="text" id="faucet_distributor_scheme_discount"
                                                                onkeypress="return (event.charCode >= 48 && event.charCode <= 57) || event.charCode === 46"
                                                               value="{{ $customerdata->faucet_distributor_scheme_discount }}"
                                                                class="form-control text-uppercase" autocomplete="off"
                                                                autofocus required />
                                                            <label class="floating-label px">Distributor Scheme
                                                                Discount</label>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-2 mb-1">
                                                        <div class="floating-label-group">
                                                            <input type="text" id="faucet_distributor_disc"
                                                                onkeypress="return (event.charCode >= 48 && event.charCode <= 57) || event.charCode === 46"
                                                               value="{{ $customerdata->faucet_distributor_disc }}"
                                                                class="form-control text-uppercase" autocomplete="off"
                                                                autofocus required />
                                                            <label class="floating-label px">Distributor Discount</label>
                                                        </div>
                                                    </div>

                                                    <div class="col-sm-2 mb-1">
                                                        <div class="floating-label-group">
                                                            <input type="text" id="faucet_retailer_ubs_scheme_disc"
                                                                onkeypress="return (event.charCode >= 48 && event.charCode <= 57) || event.charCode === 46"
                                                               value="{{ $customerdata->faucet_retailer_ubs_scheme_disc }}"
                                                                class="form-control text-uppercase" autocomplete="off"
                                                                autofocus required />
                                                            <label class="floating-label px">Retailers/Ubs Scheme
                                                                Disc.</label>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-2 mb-1">
                                                        <div class="floating-label-group">
                                                            <input type="text" id="final_faucet_discount"  value="{{  $customerdata->faucet_finaldiscount }}"
                                                            onkeypress="return (event.charCode >= 48 && event.charCode <= 57) || event.charCode === 46"
                                                                class="form-control text-uppercase" autocomplete="off" readonly
                                                                autofocus required />
                                                            <label class="floating-label-new"> Final Discount </label>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="basic-form">
                                            <form method="POST" id="form9">
                                                <div class="mb-1 row">
                                                    ...
                                                    <div class="col-sm-2 mb-1">
                                                        <div class="floating-label-group">
                                                            <input type="text" id="ex_sc_dicount"
                                                                onkeypress="return (event.charCode >= 48 && event.charCode <= 57) || event.charCode === 46"
                                                                class="form-control text-uppercase"
                                                                value="{{ $customerdata->sanitary_ex_sc_dicount }}"
                                                    ...
                                                    <div class="col-sm-2 mb-1">
                                                        <div class="floating-label-group">
                                                            <input type="text" id="sanitary_distributor_disc"
                                                                ...
                                                                class="form-control text-uppercase"
                                                               autocomplete="off" autofocus
                                                                value="{{ $customerdata->sanitary_distributor_disc }}"
                                                                required />
                                                    ...
                                                    <div class="col-sm-2 mb-1">
                                                        <div class="floating-label-group">
                                                            <input type="text" id="sanitary_dealer_line_discount"
                                                                onkeypress="return (event.charCode >= 48 && event.charCode <= 57) || event.charCode === 46"
                                                                class="form-control text-uppercase"
                                                               autocomplete="off" autofocus
                                                                value="{{ $customerdata->sanitary_dealer_line_discount }}"
                                                                required />
                                                            <label class="floating-label px">Dealer Line</label>
                                                        </div>
                                                    </div>

                                                    <div class="col-sm-2 mb-1 retailer-ubs">
                                                        <div class="floating-label-group">
                                                            <input type="text" id="final_sanitary_discount" 
                                                            onkeypress="return (event.charCode >= 48 && event.charCode <= 57) || event.charCode === 46"
                                                                class="form-control text-uppercase readonly"
                                                                value="{{ $customerdata->sanitary_finaldiscount }}"
                                                               autocomplete="off" autofocus readonly
                                                                required />
                                                            <label class="floating-label-new"> Final </label>
                                                        </div>
                                                    </div>
                        ...
                        <div class="accordion accordion-primary" id="accordion-14">
                            <div class="accordion-item accordion-bg">
                                <div class="accordion-header rounded-lg collapsed" id="heading9"
                                    data-bs-toggle="collapse" data-bs-target="#collapse14" aria-controls="collapse14"
                                    aria-expanded="false" role="button">
                                    <span class="accordion-header-icon"></span>
                                    <span class="accordion-header-text fs-14">Display Discount</span>
                                    <span class="accordion-header-indicator"></span>
                                </div>
                                <div id="collapse14" class="collapse" aria-labelledby="heading11"
                                    data-bs-parent="#accordion-14" style="">
                                    <div class="accordion-body-text mt-4">
                                        ...
                                        <div class="basic-form">
                                            <form method="POST" id="form9">
                                                <div class="mb-1 row">
                                                    ...
                                                    <div class="col-sm-2 mb-1">
                                                        <div class="floating-label-group">
                                                            <input type="text" id="display_discount"
                                                                 onkeypress="return (event.charCode >= 48 && event.charCode <= 57) || event.charCode === 46"
                                                                class="form-control text-uppercase"
                                                                value="{{ $customerdata->display_discount }}"
                                                               autocomplete="off" autofocus
                                                                required />
                                                            <label class="floating-label px">Display Discount</label>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="basic-form">
                                            <form method="POST" id="form10">
                                                <div class="mb-1 row">
                                                    ...
                                                    <div class="col-sm-4 mb-1">
                                                        <div class="float-select">
                                                            <select class="form-select form-select-sm" id="state_head"
                                                                data-control="select2" data-placeholder=" ">

                                                            </select>
                                                            <label class="new-labels">State Heads<span class="text-danger">*</span> </label>
                                                        </div>
                                                        {{-- <div class="float-select">
                                                    ...
                                                    <div class="col-sm-4 mb-1">
                                                        ...
                                                        <div class="float-select">
                                                            <select class="form-select form-select-sm" id="zonal_heads"
                                                                data-control="select2" data-placeholder=" ">
                                                            </select>
                                                            <label class="new-labels">Zonal Heads<span class="text-danger">*</span> </label>
                                                        </div>
                    ...
                    <div class="mb-4 mt-3 row">
                        ...
                        <div class="col-sm-12">
                            ...
                            <button type="submit" class="btn btn-primary subtn accordianbutton pull-right">Show
                                All</button>
...
@section('js')
    <script>
        funcustomertype().done(function(mastercustomertype) {
            ...
            var customer_type = {{ $customerdata->customer_type }}
            ...
            $.each(data, function(key, value) {
                ...
                var selected = (value.masterMenuId == customer_type) ? 'selected' : '';
        ...
        function getdistrict(statname_id) {
            var district = '{{ $customerdata->district }}';
            var selected = '';
            ...
            funcitybysate(statname_id).done(function(roles) {
                ...
                $.each(data, function(key, value) {
                    ...
                    var selected = (district == value.cityId) ? 'selected' : '';
                        if (selected === 'selected') {
                            getzone(value.cityId);
                        }
        ...
        function getzone(statname_id) {
            var zone = '{{ $customerdata->zone }}';
            var selected = '';
        ...
        funbusinesstype().done(function(masterdistributor) {
            var data = masterdistributor.data;
            var natureofbusiness = '{{ $customerdata->natureOfBuss }}';
            var selected = '';
            var options = '<option value="" >Select Nature Business</option>';
            $.each(data, function(key, value) {

                if (value.masterMenuId == natureofbusiness) {
                    var selected = 'selected';
                }
        ...
        funbanktype().done(function(masterdistributor) {
            var data = masterdistributor.data;
            var bank_name = '{{ @$bankdata->bankId_fk }}';
            var selected = '';
            var options = '<option value="" >Select Nature Business</option>';
            $.each(data, function(key, value) {

                if (bank_name == value.masterMenuId) {
                    var selected = 'selected';
                }else{
                    var selected = '';
                }
        ...
        funallsalesusers().done(function(mastersalesusers) {
            ...
            var userId_fk = '{{ @$customersalesperson->userId_fk }}';
            console.log('userId_fk => '+userId_fk);
            var stateHead = '{{ @$customerdata->stateHead }}';
           // console.log('stateHead => '+stateHead);
            var zoneHead = '{{ @$customerdata->zoneHead }}';
            var selected = '';
            var selected2 = '';
            var selected3 = '';
            var options = '<option value="" >Select sales user</option>';
            var options2 = '<option value="" >Select sales user</option>';
            var options3 = '<option value="" >Select sales user</option>';
            $.each(data, function(key, value) {
                
                
                if(value.userId == userId_fk){
                     selected = 'selected';
                }else{
                    selected = '';
                }
            ...
            $.each(data, function(key, value) {
                ...
                if(value.userId == zoneHead){
                     selected2 = 'selected';
                }else{
                    selected2 = '';
                }
                options2 += '<option value="' + value.userId + '" ' + selected2 + '>' + value.name +
                    '</option>';
            });

            $.each(data, function(key, value) {
                if(value.userId == stateHead){
                     selected3 = 'selected';
                }else{
                    selected3 = '';
                }

                options3 += '<option value="' + value.userId + '" ' + selected3 + '>' + value.name +
                    '</option>';
            });

            $('#assign_user').empty().append(options);
            $('#state_head').empty().append(options3);
            $('#zonal_heads').empty().append(options2);
        });

        funlocation().done(function(response) {
            var data = response.data;
            var state = '{{ $customerdata->state }}';
            var selected = '';
        ...
        funmainhead().done(function(response) {
            var data = response.data;
            var mainheads = '{{ $customerdata->mainHeads }}';
            var selected = '';
            var options = '<option value="" >Select State</option>';
            $.each(data, function(key, value) {

                if (value.masterMenuId == mainheads) {
                    selected = 'selected';
                }else{
                    selected = '';
                }
        ...
        funcluster().done(function(response) {
            var data = response.data;
            var cluster = '{{ $customerdata->cluster }}';
            var selected = '';
            var options = '<option value="" >Select Cluster</option>';
            $.each(data, function(key, value) {

                if (cluster == value.masterMenuId) {
                    var selected = 'selected';
                }else{
                    selected = '';
                }
        ...
        funtransproter().done(function(response) {
            var data = response.data;
            var transporterName = '{{ $customerdata->transporterName }}';
            var selected = '';
            var options = '<option value="" >Select Transproter</option>';
            $.each(data, function(key, value) {

                if (value.masterMenuId == transporterName) {
                    selected = 'selected';
                }else{
                    selected = '';
                }
        ...
        $(document).ready(function() {
            ...
            function calculatefaucetDiscount() {
                const discount1 = parseFloat($('#faucet_ex_fc_disc').val()) || 0;
                const discount2 = parseFloat($('#faucet_dealer_scheme_discount').val()) || 0;
                const discount3 = parseFloat($('#faucet_distributor_scheme_discount').val()) || 0;
                const discount4 = parseFloat($('#faucet_distributor_disc').val()) || 0;
                const discount5 = parseFloat($('#faucet_retailer_ubs_scheme_disc').val()) || 0;
         
                let totalDiscount = 1;
                totalDiscount *= (1 - discount1 / 100);
                totalDiscount *= (1 - discount2 / 100);
                totalDiscount *= (1 - discount3 / 100);
                totalDiscount *= (1 - discount4 / 100);
                totalDiscount *= (1 - discount5 / 100);
                totalDiscount = (1 - totalDiscount) * 100;
                $('#final_faucet_discount').val(totalDiscount.toFixed(2));
            }

            $('#faucet_ex_fc_disc').on('input', calculatefaucetDiscount);
            $('#faucet_dealer_scheme_discount').on('input', calculatefaucetDiscount);
            $('#faucet_distributor_scheme_discount').on('input', calculatefaucetDiscount);
            $('#faucet_distributor_disc').on('input', calculatefaucetDiscount);
            $('#faucet_retailer_ubs_scheme_disc').on('input', calculatefaucetDiscount);


            function calculatesanitaryDiscount() {
                const discount1 = parseFloat($('#ex_sc_dicount').val()) || 0;
                const discount2 = parseFloat($('#sanitary_distributor_disc').val()) || 0;
                const discount3 = parseFloat($('#sanitary_dealer_line_discount').val()) || 0;
                ...
                totalDiscount = (1 - totalDiscount) * 100;
                $('#final_sanitary_discount').val(totalDiscount.toFixed(2));
            }

            $('#ex_sc_dicount').on('input', calculatesanitaryDiscount);
            $('#sanitary_distributor_disc').on('input', calculatesanitaryDiscount);
            $('#sanitary_dealer_line_discount').on('input', calculatesanitaryDiscount);
...
if (selectedval == 180) {
    ...
    $('#faucet_distributor_scheme_discount').attr('disabled', false);
   $('#faucet_distributor_disc').attr('disabled', false);
   $('#faucet_retailer_ubs_scheme_disc').attr('disabled', true);
   $('#faucet_dealer_scheme_discount').attr('disabled', true);
   $('#sanitary_distributor_disc').attr('disabled', false);
   $('#sanitary_dealer_line_discount').attr('disabled', true);

} else if(selectedval == 179) {

   $('#faucet_distributor_scheme_discount').attr('disabled', true);
   $('#faucet_distributor_disc').attr('disabled', true);
   $('#faucet_retailer_ubs_scheme_disc').attr('disabled', true);
   $('#faucet_dealer_scheme_discount').attr('disabled', false);
   $('#sanitary_distributor_disc').attr('disabled', true);
   $('#sanitary_dealer_line_discount').attr('disabled', false);

}else if(selectedval == 310 || selectedval  == 309){

    $('#faucet_distributor_scheme_discount').attr('disabled', true);
   $('#faucet_distributor_disc').attr('disabled', true);
   $('#faucet_retailer_ubs_scheme_disc').attr('disabled', false);
   $('#faucet_dealer_scheme_discount').attr('disabled', true);
   $('#sanitary_distributor_disc').attr('disabled', true);
   $('#sanitary_dealer_line_discount').attr('disabled', true);
            ...
            $('.saveForm').on('click', function() {
                ...
                var state_head = $('#state_head').length ? $('#state_head').val() : '';
                var bank_type = $('#bank_type').val();
                var zonal_heads =  $('#zonal_heads').length ? $('#zonal_heads').val() : '';
                ...
                var chquebook_image_old = $('#chquebook_image_old').val();
                var cheque_image = $('#cheque_image')[0].files;
                var cheque_image_old = $('#cheque_image_old').val();
                var agreement_image = $('#agreement_image')[0].files;
                var agreement_image_old = $('#agreement_image_old').val();
                var adahar_number = $('#adahar_number').val();
                var adahar_front_image = $('#adahar_front_image')[0].files[0];
                var adahar_front_image_old = $('#adahar_front_image_old').val();
                var adahar_back_image = $('#adahar_back_image')[0].files[0];
                var adahar_back_image_old = $('#adahar_back_image_old').val();
                var pan_number = $('#pan_number').val();
                var pan_card_image = $('#pan_card_image')[0].files[0];
                var pan_card_image_old = $('#pan_card_image_old').val();
                var assign_user = $('#assign_user').val();
                var consignee_name = $('#consignee_name').val();
                // var faucet_ex_fc_disc = $('#faucet_ex_fc_disc').val();
                // var faucet_dealer_scheme_discount = $('#faucet_dealer_scheme_discount').val();
                // var faucet_distributor_scheme_discount = $('#faucet_distributor_scheme_discount').val();
                // var faucet_distributor_disc = $('#faucet_distributor_disc').val();
                // var faucet_retailer_ubs_scheme_disc = $('#faucet_retailer_ubs_scheme_disc').val();
                // var final_faucet_discount = $('#final_faucet_discount').val();
                // var sanitary_distributor_disc = $('#sanitary_distributor_disc').val();
                // var sanitary_dealer_line_discount = $('#sanitary_dealer_line_discount').val();
                // var final_sanitary_discount = $('#final_sanitary_discount').val();
                // var ex_sc_dicount = $('#ex_sc_dicount').val();
                // var display_discount = $('#display_discount').val();


                var faucet_ex_fc_disc = $('#faucet_ex_fc_disc').length ? $('#faucet_ex_fc_disc').val() : '';
                var faucet_dealer_scheme_discount = $('#faucet_dealer_scheme_discount').length ? $(
                    '#faucet_dealer_scheme_discount').val() : '';
                var faucet_distributor_scheme_discount = $('#faucet_distributor_scheme_discount').length ?
                    $('#faucet_distributor_scheme_discount').val() : '';
                var faucet_distributor_disc = $('#faucet_distributor_disc').length ? $(
                    '#faucet_distributor_disc').val() : '';
                var faucet_retailer_ubs_scheme_disc = $('#faucet_retailer_ubs_scheme_disc').length ? $(
                    '#faucet_retailer_ubs_scheme_disc').val() : '';
                var sanitary_distributor_disc = $('#sanitary_distributor_disc').length ? $(
                    '#sanitary_distributor_disc').val() : '';
                var sanitary_dealer_line_discount = $('#sanitary_dealer_line_discount').length ? $(
                    '#sanitary_dealer_line_discount').val() : '';
                var final_faucet_discount = $('#final_faucet_discount').length ? $('#final_faucet_discount')
                    .val() : '';
                var final_sanitary_discount = $('#final_sanitary_discount').length ? $(
                    '#final_sanitary_discount').val() : '';
                var ex_sc_dicount = $('#ex_sc_dicount').length ? $('#ex_sc_dicount').val() : '';
                var display_discount = $('#display_discount').length ? $('#display_discount').val() : '';
                ...
                formData.append('display_discount', display_discount);
                ...
                formData.append('faucet_dealer_scheme_discount',faucet_dealer_scheme_discount);
                formData.append('faucet_distributor_scheme_discount',faucet_distributor_scheme_discount);
                formData.append('faucet_distributor_disc',faucet_distributor_disc);
                formData.append('faucet_retailer_ubs_scheme_disc',faucet_retailer_ubs_scheme_disc);
                formData.append('ex_sc_dicount',ex_sc_dicount);
                formData.append('sanitary_distributor_disc',sanitary_distributor_disc);
                formData.append('sanitary_dealer_line_discount',sanitary_dealer_line_discount);
                formData.append('final_faucet_discount',final_faucet_discount);
                formData.append('final_sanitary_discount',final_sanitary_discount);
                formData.append('agreement_image_old', agreement_image_old);
                formData.append('chquebook_image_old', chquebook_image_old);
                formData.append('cheque_image', cheque_image);
                formData.append('cheque_image_old', cheque_image_old);
                formData.append('adahar_number', adahar_number);
                formData.append('adahar_front_image', adahar_front_image);
                formData.append('adahar_front_image_old', adahar_front_image_old);
                formData.append('adahar_back_image', adahar_back_image);
                formData.append('adahar_back_image_old', adahar_back_image_old);
                formData.append('pan_number', pan_number);
                formData.append('pan_card_image', pan_card_image);
                formData.append('pan_card_image_old', pan_card_image_old)
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        var redirecturl = "{{ route('customer.distributorlist') }}";
                        if (resp == 1) {
