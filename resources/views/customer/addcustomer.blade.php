...
@php
    $required = session('userinfo')->role_type == 3 ? '<span class="text-danger">*</span>' : '';
@endphp
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack p-0 m-0">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1 ml-10">
                    ...
                    <li class="breadcrumb-item text-dark">Distribution Network-Add New</li>
                                                    ...
                                                    <div class="mb-1 row">
                                                        ...
                                                        <div class="col-sm-4 mb-4">
                                                            <div class="floating-label-group">
                                                                <input type="text" id="customer_name"
                                                                    ...
                                                                    required />
                                                                <label class="floating-label px">Company Name {!! $required !!} </label>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-sm-4 mb-4">
                                                            <div class="floating-label-group">
                                                                <input type="text" id="nature_name"
                                                                    class="form-control" autocomplete="off" autofocus
                                                                    required />
                                                                <label class="floating-label ">Owner Name {!! $required !!} </label>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-sm-4 mb-4">
                                                            <div class="floating-label-group">
                                                                <input type="text" id="phone_no"
                                                                    ...
                                                                    required />
                                                                <label class="floating-label">Mobile No. {!! $required !!} </label>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-sm-4 mb-1">
                                                            <div class="floating-label-group">
                                                                ...
                                                                <label class="floating-label ">Email Id {!! $required !!} </label>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-sm-4">
                                                            <div class="float-select">
                                                                ...
                                                                <label class="new-labels"> Main Heads {!! $required !!} </label>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-sm-4">
                                                            <div class="float-select">
                                                                ...
                                                                <label class="new-labels">Cluster {!! $required !!} </label>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-sm-4 mb-1">
                                                            <div class="floating-label-group">
                                                                <input type="text" id="gst"
                                                                    class="form-control text-uppercases"
                                                                    autocomplete="off" autofocus required />
                                                                <label class="floating-label">GST No.{!! $required !!} </label>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-sm-4 mb-1">
                                                            ...
                                                            <div class="form-floating">
                                                                ...
                                                                <label for="floatingTextarea"
                                                                    class="floatingTextarea">Street</label>
                                                            </div>
                                                        ...
                                                        <div class="col-sm-4 mb-1">
                                                            ...
                                                            <div class="floating-label-group mt-1">
                                                                <input type="text" id="pin_code" class="form-control"
                                                                    ...
                                                                    onkeypress="return event.charCode >= 48 &amp;&amp; event.charCode <= 57"
                                                                    autocomplete="off" autofocus required />
                                                                <label class="floating-label px">Enter Pin Code {!! $required !!} </label>
                                                            </div>
                                                    ...
                                                    <div class="col-sm-2 mb-1">
                                                        ...
                                                        <div class="floating-label-group">
                                                            <input type="text" name="contact_person_name[]"
                                                                class="form-control" autocomplete="off" autofocus
                                                                required />
                                                            <label class="floating-label">Name {!! $required !!} </label>
                                                        </div>
                                                    ...
                                                    <div class="col-sm-2 mb-1">
                                                        ...
                                                        <div class="floating-label-group">
                                                            <input type="text" name="contact_person_degination[]"
                                                                class="form-control" autocomplete="off" autofocus
                                                                required />
                                                            <label class="floating-label">Designation {!! $required !!} </label>
                                                        </div>
                                                    ...
                                                    <div class="col-sm-3 mb-1">
                                                        ...
                                                        <div class="floating-label-group mt-1">
                                                            <input type="text" name="contact_person_email[]"
                                                                class="form-control " autocomplete="off" autofocus
                                                                required />
                                                            <label class="floating-label px">Email {!! $required !!} </label>
                                                        </div>
                                                    ...
                                                    <div class="col-sm-3 mb-1">
                                                        ...
                                                        <div class="floating-label-group mt-1">
                                                            <input type="text" class="form-control"
                                                                ...
                                                                onkeypress="return event.charCode >= 48 &amp;&amp; event.charCode <= 57"
                                                                autocomplete="off" autofocus required />
                                                            <label class="floating-label px">Mobile {!! $required !!} </label>
                                                        </div>
                                                ...
                                                <div class="mb-1 row">
                                                    ...
                                                    <div class="col-sm-4 ">
                                                        <div class="float-select">
                                                            ...
                                                            <label class="new-labels"> Bank Type {!! $required !!} </label>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-4 ">
                                                        ...
                                                        <div class="floating-label-group">
                                                            <input type="text" id="account_number" maxlength="17"
                                                ...
                                                <div class="mb-1 row">
                                                    ...
                                                    <div class="col-sm-4 ">
                                                        <div class="float-select">
                                                            ...
                                                            <label class="new-labels">Blank Cheque {!! $required !!} </label>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-4 mb-1">
                                                        ...
                                                        <div class="floating-label-group mt-1">
                                                            <input type="text" id="amount" class="form-control "
                                                                onkeypress="return event.charCode >= 48 &amp;&amp; event.charCode <= 57"
                                                                autocomplete="off" autofocus required />
                                                            <label class="floating-label w-100px">Amount {!! $required !!} </label>
                                                        </div>
                                            ...
                                            <form method="POST" id="form9">
                                                <div class="mb-1 row">
                                                    <div class="col-sm-4 mb-1">
                                                        ...
                                                        <div class="floating-label-group">
                                                            <input type="text" id="pan_number" maxlength="10"
                                                                class="form-control text-uppercase" autocomplete="off"
                                                                autofocus required />
                                                ...
                                                <form method="POST" id="form9">
                                                    <div class="mb-1 row">
                                                        ...
                                                        <div class="col-sm-2 mb-1">
                                                            <div class="floating-label-group">
                                                                <input type="text" id="faucet_dealer_scheme_discount"
                                                                    ...
                                                                    class="form-control text-uppercase" autocomplete="off"
                                                                    autofocus required />
                                                                <label class="floating-label px">Dealer Scheme
                                                                    Discount</label>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-sm-2 mb-1">
                                                            <div class="floating-label-group">
                                                                <input type="text"
                                                                    id="faucet_distributor_scheme_discount" 
                                                                    onkeypress="return (event.charCode >= 48 && event.charCode <= 57) || event.charCode === 46"
                                                                    class="form-control text-uppercase" autocomplete="off"
                                                                    autofocus required />
                                                        ...
                                                        <div class="col-sm-2 mb-1">
                                                            <div class="floating-label-group">
                                                                <input type="text" id="faucet_distributor_disc"
                                                                    ...
                                                                    class="form-control text-uppercase" autocomplete="off"
                                                                    autofocus required />
                                                                <label class="floating-label px">Distributor
                                                                    Discount</label>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-sm-2 mb-1">
                                                            <div class="floating-label-group">
                                                                <input type="text" id="final_faucet_discount"
                                                                    value="42"
                                                                    onkeypress="return (event.charCode >= 48 && event.charCode <= 57) || event.charCode === 46"
                                                                    class="form-control text-uppercase" autocomplete="off"
                                                    ...
                                                    <div class="mb-1 row">
                                                        ...
                                                        <div class="col-sm-2 mb-1">
                                                            <div class="floating-label-group">
                                                                ...
                                                                onkeypress="return (event.charCode >= 48 && event.charCode <= 57) || event.charCode === 46"
                                                                    class="form-control text-uppercase" value="42"
                                                                    autocomplete="off" autofocus required />
                                                                <label class="floating-label px">EX FC Discount</label>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-sm-2 mb-1 d-none">
                                                            <div class="floating-label-group">
                                                                <input type="text" id="sanitary_cash_discount"
                                                                    onkeypress="return (event.charCode >= 48 && event.charCode <= 57) || event.charCode === 46"
                                                                    class="form-control text-uppercase" autocomplete="off"
                                                                    autofocus required />
                                                                <label class="floating-label px">Cash</label>
                                                            </div>
                                                        </div>

                                                        <div class="col-sm-2 mb-1 d-none">
                                                            <div class="floating-label-group">
                                                                <input type="text" id="sanitary_display_discount"
                                                                    onkeypress="return (event.charCode >= 48 && event.charCode <= 57) || event.charCode === 46"
                                                                    class="form-control text-uppercase" autocomplete="off"
                                                                    autofocus required />
                                                                <label class="floating-label px">Dispaly</label>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-sm-2 mb-1 retailer-ubs">
                                                            <div class="floating-label-group">
                                                                <input type="text" id="final_sanitary_discount"
                                                                    ...
                                                                    autocomplete="off" autofocus readonly required />
                                                ...
                                                <form method="POST" id="form10">
                                                    <div class="mb-1 row">
                                                        <div class="col-sm-4 mb-1">
                                                            <div class="float-select">
                                                                <select class="form-select form-select-sm"
                                                                    id="assign_user" data-control="select2"
                                                                    data-placeholder=" ">
                                                        ...
                                                        <div class="col-sm-4 mb-1">
                                                            <div class="float-select">
                                                                <select class="form-select form-select-sm"
                                                                    id="state_head" data-control="select2"
                                                                    data-placeholder=" ">

                                                                </select>
                                                                <label class="new-labels">State Heads {!! $required !!} </label>
                                                            </div>
                                                            {{-- <div class="float-select">
                                                        ...
                                                        <div class="col-sm-4 mb-1">
                                                            ...
                                                            <div class="float-select">
                                                                <select class="form-select form-select-sm"
                                                                    id="zonal_heads" data-control="select2"
                                                                    data-placeholder=" ">
                                                                </select>
                                                                <label class="new-labels">Zonal Heads {!! $required !!} </label>
                                                            </div>
                                                    ...
                                                    <div class="mb-1 row">
                                                        <div class="col-sm-6 mb-1">
                                                            ...
                                                            <div class="form-floating">
                                                                <textarea class="form-control" id="ṛemarks"></textarea>
                                                                <label for="floatingTextarea"
                                                                    class="floatingTextarea">Remarks</label>
                                                            </div>
...
@section('js')
    <script>
        ...
        funbdistributorstatus().done(function(masterdistributor) {
            ...
            $.each(data, function(key, value) {
                var isSelected = (usertype == 3 && value.masterMenuId == 185) ? 'selected' : '';
                options += '<option value="' + value.masterMenuId + '" ' + isSelected + '>' + value.name +
                    '</option>';
            });
        ...
        funallsalesusers().done(function(mastersalesusers) {
            ...
            $('#zonal_heads').empty().append(options);
            $('#state_head').empty().append(options);
        });
        ...
        $(document).ready(function() {
            ...
            var cityCache = {};
            $('#select_state').change(debounce(function() {
                var statname_id = $(this).val();
                if (statname_id) {
                    if (cityCache[statname_id]) {
                        updateCityOptions(cityCache[statname_id]);
                    } else {
                        funcitybysate(statname_id).done(function(roles) {
                            var data = roles.data;
                            cityCache[statname_id] = data; // Cache the result
                            updateCityOptions(data);
                        });
                    }
                } else {
                    $('#select_city').empty().append('<option value="">Select City Name</option>');
                }
            }, 300));
            ...
            $('.saveForm').on('click', function() {
                ...
                // console.log('select_zone =>'+select_zone);
                ...
                var assign_user = $('#assign_user').length ? $('#assign_user').val() : '';
