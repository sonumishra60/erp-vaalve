                                                        ...
                                                        <div class="col-sm-2 mb-new">
                                                            <div class="floating-label-group">
                                                                <input type="text" id="empcode" class="form-control"
                                                                    ...
                                                                    value="{{ $userlist->emp_code }}" autocomplete="off"
                                                                    >
...
@section('js')
    <script>
        ...
        funbdistributorstatus().done(function(masterdistributor) {
            ...
            var state = '{{ $userlist->staus }}';

            var data = masterdistributor.data;
            var options = '<option value="" >Select User Status</option>';
            $.each(data, function(key, value) {
                selected = (state == value.masterMenuId) ? 'selected' : '';
