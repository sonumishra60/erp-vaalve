        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack p-0 m-0">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1 ml-10">
                    ...
                    <li class="breadcrumb-item text-dark">Add series</li>
                </ul>
                <!--end::Title-->
            </div>
        </div>
                                    ...
                                    <div class="mb-1 row">
                                        <div class="col-sm-3 mb-3">
                                            <div class="float-select">
                                                ...
                                                <label class="new-labels"> Select Category <span class="text-danger" >*</span></label>
                                            </div>
                                        </div>
    ...
    <script>
        $(document).ready(function() {
               ...
               // var masterdata = $('#masterdata').val();
                ...
                if (checkvalidation == 0) {
                   ...
                   // return false;
                    ...
                    $.ajax({
                        type: 'POST',
                        url: "{{ route('mastermenu.seriesformsubmit') }}",
                        data: formData,
                        processData: false,
                        contentType: false,
            ...
            function fetchData(rowCount, page, masterdata) {
                ...
                $.ajax({
                    url: "{{ route('mastermenu.seriesdata') }}",
                    method: 'GET',
                    data: {
