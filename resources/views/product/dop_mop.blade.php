        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack p-0 m-0">
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1 ml-10">
                    ...
                    <li class="breadcrumb-item text-dark">DOP/MOP List</li>
    ...
    <script>
        $(document).ready(function() {
            ...
            function fetchData(rowCount, page) {
                ...
                $.ajax({
                    url: "{{ route('product.dopmoplistdata') }}",
                    method: 'GET',
                    data: {
                        rowCount: rowCount,
                        page: page
                        ...
                        if (countdata != 0) {
                            ...
                            $.each(data.data, function(index, value) {
                                ...
                                var tr = ` <tr>
                                        ...
                                        <td class="w-30px rounded-start"> `+ imgae +`
                                        </td>
                                        <td class="w-60px text-end">` + value.startdate + `</td>
                                        <td class="w-60px text-end">` + value.enddate + `</td>
                                        <td class="w-60px text-end">` + value.status_to + `</td>
                                           @if(session('userinfo')->role_type == 2 )
            ...
            function searchData(searchParams) {
                ...
                $.ajax({
                    url: "{{ route('product.dopmopsearch') }}", // Replace with your backend route
                    method: 'GET',
                    data: searchParams,
                    success: function(response) {
                        var data = response.data;
