                        ...
                        <div class="col-md-12 mb-3">
                            <div class="row">
                                <div class="col-md-4 ">
                                    ...
                                    <a href="#"
                                        class="btn btn-primary checkInbutton {{ $trans_clientvisit->checkInDate && $trans_clientvisit->checkOutDate ? '' : 'd-none' }}">Check In</a>
                                    <a href="#"
                            ...
                            <thead>
                                <tr class="fw-bolder bg-light">
                                    ...
                                    <th class="w-100px rounded-start">
                                        <div class="floating-label-group">Distributor </div>
                                    </th>

                                    <th class="w-100px rounded-start">
                                        <div class="floating-label-group">Retailer/Owner Name</div>
                                    </th>
                        ...
                        <div class="row new-client d-none">
                            ...
                            <div class="col-sm-4 mb-1">
                                <div class="floating-label-group mb-3">
                                    <input type="text" id="dealer_name" class="form-control " required="" autocomplete="off">
    ...
    $(document).ready(function() {
                ...
                navigator.geolocation.getCurrentPosition(
                    async (position) => {
                            try {
                                ...
                                if (checkvalidation > 0) return false;

                                $checkInButton.prop('disabled', true).text('Saving...');
                                ...
                                // Add compressed meter reading image
                                ...
                                $.ajax({
                                    ...
                                    contentType: false,
                                    success: function(response) {
                                        $checkInButton.text('Save').prop('disabled', false);
                                        let data = typeof response === 'string' ? JSON.parse(response) : response;
                                        if (data.status === 200) {
                                            toastr.success('Check In Inserted Successfully');
                                    ...
                                    error: function(xhr, status, error) {
                                        $checkInButton.text('Check In').prop('disabled', false);
                                        console.error('Error:', error);
                                    }
                                });
                        ...
                        (error) => {
                            ...
                            toastr.error('Failed to get location. Please enable location services and try again.');
                        }, {
        ...
        function handleGeolocationError(error) {
            if (error.code === error.PERMISSION_DENIED) {
                toastr.error("Location access denied. Please enable location services and try again.");
            } else if (error.code === error.POSITION_UNAVAILABLE) {
                toastr.error("Location information is unavailable. Please try again later.");
