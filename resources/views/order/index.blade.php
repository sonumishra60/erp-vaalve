...
@section('content')
    ...
    <div class="post d-flex flex-column-fluid" id="kt_post">
        <div id="kt_content_container" class="container-xxl">
                                    ...
                                    <div class="mb-1 row">
                                        <div class="col-sm-3 mb-1">
                                            <div class="float-select">
                                                ...
                                                <label class="new-labels"> Select Distributor Network <span
                                            ...
                                            <div class="floating-label-group mb-3">
                                                <input type="text" id="discount" class="form-control "
                                                    ...
                                                    required=""
                                                    {{ session('userinfo')->role_type == 3 ? 'readonly' : '' }}
                                                    autocomplete="off">
                                                ...
                                                <input type='hidden' name="faucet_finaldiscount" id="faucet_finaldiscount">
                                                <input type='hidden' name="display_discount" id="display_discount">
                                                <input type='hidden' name="sales_person" id="sales_person_id">
                                                <input type='hidden' name="pendingtgt" id="pending_tgt">
                                                <input type='hidden' name="consigneecount" id="consigneecount">
                                                <input type='hidden' name="consigneecustomer" id="consigneecustomer">
                                                <label class="floating-label-new">Discount(%) <span
                                                        class="text-danger">*</span> </label>
                                            </div>
                                            ...
                                            <div class="form-floating mb-3">
                                                <textarea class="form-control" id="shipping_address"></textarea>
                                        ...
                                        <div class="col-sm-3 mb-1">
                                            ...
                                            <div class="float-select">
                                                ...
                                                <label class="new-labels">Category <span class="text-danger">*</span>
                                                </label>
                                            </div>
                                        ...
                                        <div class="col-sm-3">
                                            ...
                                            <div class="float-select">
                                                ...
                                                <label class="new-labels">Order Type <span class="text-danger">*</span>
                                                </label>
                                            </div>
                                            ...
                                            <div class="floating-label-group  mb-3">
                                                <input type="text" id="target_value" class="form-control"
                                                    onkeypress="return event.charCode >= 48 &amp;&amp; event.charCode <= 57"
                                                    required="" readonly autocomplete="off">
                                                <label class="floating-label-new">Target Value <span
                                                        class="text-danger">*</span> </label>
                                            </div>
                                        ...
                                        <div class="col-sm-3 mb-1">
                                            ...
                                            <div class="float-select">
                                                ...
                                                <label class="new-labels">Brand <span class="text-danger">*</span>
                                                </label>
                                            </div>
                                            ...
                                            <div class="float-select">
                                                ...
                                                <label class="new-labels">Transport <span class="text-danger">*</span>
                                                </label>
                                            </div>
                                            ...
                                            <div class="floating-label-group mb-3">
                                                <input type="text" id="order_date" class="form-control"
                                                    ...
                                                    autocomplete="off">
                                                <label class="floating-label-new">Order Date <span
                                                        class="text-danger">*</span> </label>
                                            </div>

                                            <div class="floating-label-group mb-3 d-none">
                                                <input type="text" class="form-control bank_check_recieved_date"
                                                    id="deliverydate" autocomplete="off" required="">
                                                <label class="floating-label px">Delivery Date <span
                                                        class="text-danger">*</span></label>
                                            </div>
            ...
            <div class="row mb-5 mb-xl-8 product_infromation d-none">
                <div class="card">
                    <div class="card-header ">
                        <h3 class="card-title align-items-start flex-column">
                        ...
                        <input type="text" class="form-control" id="myInput2" oninput="debounceSearch()"
                            placeholder="Search..." title="Search in table">
                    </div>
                    <div class="card-body">
            ...
            <div class="row mb-5 mb-xl-8" id="item-info-section" style="display:none;">
                <div class="card">
                    <div class="card-header ">
                        <h3 class="card-title align-items-start flex-column">
                    ...
                    <div class="card-body py-3">
                            ...
                            <table class="table table-striped table-bordered">
                                ...
                                <tfoot class="bdr-top">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right amountafterdiscount"></td>
                                    </tr>
                                    <tr>
                        ...
                        <a href="#" class="btn btn-sm btn-primary pull-right ordersubmit"> Save
...
@section('js')
    <script>
        ...
        if (isMobileDevice()) {
            ...
            function search() {
                ...
                items.forEach(function(item) {
                    ...
                    var txtValue = productNameElement ? productNameElement.textContent || productNameElement
                        .innerText : "";
        ...
        $(document).ready(function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (consigneecount <= 1) {
                            ...
                            // 05-03-2025 new code added here
                            console.log(orderconsignee[0].customerId);
                            $('#consigneecustomer').val(orderconsignee[0].customerId);
                            $('#shipping_address').val(orderconsignee[0].address);
                            // 05-03-2025 new code added here
                        ...
                        if (order_category != '') {
                            ...
                            if (order_category == 'Allied & Faucet' & order_type == '228') {
                                ...
                                var faucet_ex_fc_disc = parseFloat($('#faucet_ex_fc_disc')
                                    .val()) || 0;
                                var display_discount = parseFloat($('#display_discount')
                                    .val()) || 0;
                                let totalDiscount = 1;
                            ...
                            } else if (order_category == 'Allied & Faucet' & order_type ==
                                '229') {
                                ...
                                var sanitary_ex_sc_dicount = parseFloat($(
                                    '#sanitary_ex_sc_dicount').val()) || 0;
                                var display_discount = parseFloat($('#display_discount')
                                    .val()) || 0;
                                let totalDiscount = 1;
                                totalDiscount *= (1 - display_discount / 100);
                        ...
                        if (customertype == 'distributor' || customertype == 'dealer') {
                            ...
                            $('.accordion').each(function() {
                                ...
                                if (isMobileDevice()) {
                                    ...
                                    $(this).find('.box-tb ul').each(function() {

                                        dealerdistributor_mrp = $(this).find(
                                            '.dealerdistributor_mrp').val();
                                        startdate = parseInt($(this).find(
                                            '.startdate').val());
                                        enddate = parseInt($(this).find(
                                            '.enddate').val());
                                        currentdate = parseInt($(this).find(
                                            '.currentdate').val());

                                        if (currentdate >= startdate &&
                                            currentdate <= enddate) {

                                            if (dealerdistributor_mrp &&
                                                dealerdistributor_mrp.trim() !==
                                                '') {
                                                distributormrp =
                                                    moneyFormatIndia(
                                                        dealerdistributor_mrp) +
                                                    '<span class="text-danger">*</span>';
                                                mrptype = 'netrate';
                                            } else {
                                                distributormrp =
                                                    moneyFormatIndia($(this)
                                                        .find('.default_mrp')
                                                        .val());
                                                mrptype = 'mrp';
                                            }
                                            ...
                                            distributormrp = moneyFormatIndia($(
                                                this).find(
                                                '.default_mrp').val());
                                            mrptype = 'mrp';
                                        }
                            ...
                            $('.accordion').each(function() {
                                ...
                                if (isMobileDevice()) {
                                    ...
                                    $(this).find('.box-tb ul').each(function() {
                                        ...
                                        retailer_ubs_mrp = $(this).find(
                                            '.retailer_ubs_mrp').val();
                                        startdate = parseInt($(this).find(
                                            '.startdate').val());
                                        enddate = parseInt($(this).find(
                                            '.enddate').val());
                                        ...
                                        if (currentdate >= startdate &&
                                            ...
                                            if (retailer_ubs_mrp &&
                                                retailer_ubs_mrp.trim() !== ''
                                            ) {
                                                ubsmrp = moneyFormatIndia(
                                                        retailer_ubs_mrp) +
                                                    '<span class="text-danger">*</span>';
                                                mrptype = 'netrate';
                                            } else {
                                            ...
                                            ubsmrp = moneyFormatIndia($(this)
                                                .find('.default_mrp').val());
                                            mrptype = 'mrp';
                                        }

                                        $(this).find('.price').html(ubsmrp);
                                        $(this).find('.mrptype').val(mrptype);
                                    ...
                                    $(this).find('tbody tr').each(function() {
                                        ...
                                        if (currentdate >= startdate &&
                                            ...
                                            if (retailer_ubs_mrp &&
                                                ...
                                                //  ubsmrp = retailer_ubs_mrp;
                                                ubsmrp = moneyFormatIndia(
                                                        retailer_ubs_mrp) +
                                                    '<span class="text-danger">*</span>';
                                                mrptype = 'netrate';
                                            } else {
                                                //ubsmrp = $(this).find('.default_mrp').val();
                                                ubsmrp = moneyFormatIndia($(
                                                        this).find(
                                                        '.default_mrp')
                                                    .val());
            ...
            function getconsigeenname(distributor) {
                let url = "{{ route('order.consignee', ['id' => 'placeholder']) }}";
                url = url.replace('placeholder', distributor);
            ...
            $(document).on('click', '.ordersubmit', function() {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        // if (mtd_value == '') {
                        //     toastr.error('Enter MTD value');
                        //     $('#mtd_value').css('border-color', 'red');
                        //     checkvalidation++;
                        // } else {
                        //     $('#mtd_value').css('border-color', '');
                        // }
                        ...
                        if (payment_date == '') {
                            toastr.error('Select Payment Date');
                            $('#payment_date').css('border-color', 'red');
                            checkvalidation++;
                        } else {
                            $('#payment_date').css('border-color', '');
                        }
                        ...
                        if (checkvalidation == 0) {
                            ...
                            $.ajax({
                                ...
                                success: function(response) {
                                    ...
                                    if (response == 1) {
                                        toastr.success('Order Add Sucessfully');
        ...
        $(document).on('input', '.qty, .mobileqty', function() {
            ...
            if (isMobileDevice()) {
                ...
                var totalamountSubtotal = moneyFormatIndia(totalAmount);
                ...
                var productlist = `<div class="box-tb">
                 ...
                 <div class="row">
                     <ul class="dptext d-flex mlnew">
                         ...
                         <li style='padding-right:15px'><strong>Series:</strong> <span class="lig-tx">` + seriesName + `</span></li>
                         <li style='padding-right:15px' ><strong>MRP:</strong> <span class="lig-tx">${price +''+starticon}</span></li>
                         <li  style='padding-right:15px' class="pdnew"><strong>Amount:</strong>${totalamountSubtotal} </li>
                ...
                if (existingRow.length > 0) {
                    ...
                    if (qty > 0 && qty !== '') {
                        $('#product-list-mobile').append(
                            productlist); // Append the new row if qty > 0 and qty is not empty
                    }
                }
                ...
                var priceshow = moneyFormatIndia(price);
                ...
                var existingRow = $('#product-list').find('.cartproductId[value="' + productId + '"]').closest(
                    'tr');
        ...
        function updateSubtotalmobile() {
            ...
            $('#product-list-mobile ul').each(function() {
                ...
                console.log('discountAmount mobile =>' + discountAmount);
            ...
            if (productArrayLength > 0) {
                $.ajax({
                    ...
                    <div class="row">
                        ...
                        <div class="col-2 qt-box pl-0"><input class="form-control form-ctr2 qty" value="` + value
                                .freeqty + `" readonly="" type="text"></div>
                    </div>
                    <div class="row">
                        <ul class="dptext d-flex mlnew">
                            ...
                            <li style='padding-right:15px'><strong>Series :</strong> <span class="lig-tx">` +
                                capitalizeFirstLetter(value.seriesName) + `</span></li>
        ...
        function updateSubtotal() {
            ...
            // console.log('fhhfhf =>'+pending_tgt);
            ...
            $('.bdr-top .totalquantity').text(moneyFormatIndia(totalqty));
                    ...
                    success: function(response) {
                        ...
                        $.each(response, function(index, value) {
                           ...
                           <input type="hidden" value="` + value.productId + `" class="cartproductId">
                            ...
                            $('#free-product-list tr').each(function() {
                                var quantity1 = parseFloat($(this).find('.quantity').text()) ||
                                    0;
                                totalqty1 += quantity1;
