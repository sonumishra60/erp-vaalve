        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack p-0 m-0">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1 ml-10">
                    ...
                    <li class="breadcrumb-item text-dark">OrderList</li>
            ...
            <div class="d-flex align-items-center mr-20px">
                <a href="{{ route('order.index') }}" class="btn btn-sm btn-primary"> Add Order</i></a>
            </div>
            <!--end::Page title-->
        </div>
        <!--end::Container-->
                            ...
                            <table class="table border table-striped">
                                ...
                                <thead>
                                    <tr class="fw-bolder bg-light">
                                        ...
                                        <th class="w-100px rounded-start">
                                            <div class="floating-label-group">
                                                <input type="text" id="amount" class="form-control" autocomplete="off" required="">
                                        ...
                                        <th class="w-190px rounded-start">
                                            <div class="floating-label-group">
                                                <input type="text" id="discount" class="form-control" autocomplete="off" required="">
                                        ...
                                        <th class="w-100px rounded-start">
                                            <div class="floating-label-group">
                                                <input type="text" id="gst_amt" class="form-control" autocomplete="off" required="">
                    ...
                    if (countdata != 0) {
                        $.each(response.data, function(index, value) {
                            ...
                            var orderDispatchId = value.orderDispatchId;
                                ...
                                if (roleType == 2) {
                                    deleteButton = `<a class="delete" data-id="` + value.orderId + `"> <i class="fa fa-trash text-danger"></i> </a>`;
                                }

                                if(orderDispatchId != null){
                                    var editutton = ''; 
                                }else{
                                    var editutton = ` <a href="` + editurl + `" title="Edit" ><i class="fas fa-pencil-alt text-primary"></i> </a>`;
                                }
